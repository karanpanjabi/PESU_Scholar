...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="profile_page_css6.css" />
	<link rel="icon" type="image" href="logo.jpg">
    <!-- <script src="main.js"></script> -->
</head>

<body>
	<div class="main">&nbsp;&nbsp;&nbsp;PESU Scholar
			<span>
			
			<a href="contactus.html" class="navi">Contact Us</a>&nbsp;|&nbsp;
			<a href="logout.php" id="logout_button">Logout</a>&nbsp;&nbsp;</span>
		</div>
    <div id="navbar">
        <!--<nav>
    ...
    <div id="div_profile">
        <section>
            ...
            <div id="div_accinfo">
                <h1 class="white_text inlineob" id="prof_name">ABC</h1>
                <h3 class="white_text" id="acc_type">Student</h3>
            </div>
        </section>
    ...
    <div id="contact_info">
        ...
        <p id="contact_info_p" class="white_text">
            E-mail: <span id="prof_email">abc@xyz.com</span> <br><br>
